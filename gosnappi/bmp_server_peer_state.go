...
// The last set of BMP stats sent by the BMP client for this peer. The set of supported stats are available at https://www.rfc-editor.org/rfc/rfc7854.html#section-4.8. It might be all zeroed or empty if no stats have been received yet or peer is still in down state.
