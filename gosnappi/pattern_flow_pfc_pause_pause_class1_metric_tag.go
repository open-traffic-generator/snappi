...
type marshalPatternFlowPfcPausePauseClass1MetricTag interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowPfcPausePauseClass1MetricTag to raw JSON text
...
func (m *marshalpatternFlowPfcPausePauseClass1MetricTag) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
