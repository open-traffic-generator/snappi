...
type FlowCfmLbr interface {
	...
	// AppendEndTlv returns bool, set in FlowCfmLbr.
	AppendEndTlv() bool
	// SetAppendEndTlv assigns bool provided by user to FlowCfmLbr
	SetAppendEndTlv(value bool) FlowCfmLbr
	// HasAppendEndTlv checks if AppendEndTlv has been set in FlowCfmLbr
...
func (obj *flowCfmLbr) AppendEndTlv() bool {
...
// When true, the implementation appends an End TLV (Type 0, IEEE 802.1Q-2018 Table 21-17) after all TLVs in the tlvs list. Set to false only when testing DUT behaviour with a deliberately missing End TLV.
// AppendEndTlv returns a bool
func (obj *flowCfmLbr) HasAppendEndTlv() bool {
	return obj.obj.AppendEndTlv != nil
}

// When true, the implementation appends an End TLV (Type 0, IEEE 802.1Q-2018 Table 21-17) after all TLVs in the tlvs list. Set to false only when testing DUT behaviour with a deliberately missing End TLV.
// SetAppendEndTlv sets the bool value in the FlowCfmLbr object
func (obj *flowCfmLbr) SetAppendEndTlv(value bool) FlowCfmLbr {
