...
type marshalPatternFlowUdpSrcPort interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowUdpSrcPort to raw JSON text
...
func (m *marshalpatternFlowUdpSrcPort) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
type PatternFlowUdpSrcPort interface {
	...
	// Random returns PatternFlowUdpSrcPortRandom, set in PatternFlowUdpSrcPort.
	// PatternFlowUdpSrcPortRandom is integer random pattern
	Random() PatternFlowUdpSrcPortRandom
	// SetRandom assigns PatternFlowUdpSrcPortRandom provided by user to PatternFlowUdpSrcPort.
	// PatternFlowUdpSrcPortRandom is integer random pattern
	SetRandom(value PatternFlowUdpSrcPortRandom) PatternFlowUdpSrcPort
	// HasRandom checks if Random has been set in PatternFlowUdpSrcPort
	HasRandom() bool
	setNil()
}
...
var PatternFlowUdpSrcPortChoice = struct {
	...
	RANDOM    PatternFlowUdpSrcPortChoiceEnum
}{
	...
	RANDOM:    PatternFlowUdpSrcPortChoiceEnum("random"),
}
...
func (obj *patternFlowUdpSrcPort) setChoice(value PatternFlowUdpSrcPortChoiceEnum) PatternFlowUdpSrcPort {
	...
	if value == PatternFlowUdpSrcPortChoice.RANDOM {
		obj.obj.Random = NewPatternFlowUdpSrcPortRandom().msg()
	}
...
// description is TBD
// Random returns a PatternFlowUdpSrcPortRandom
func (obj *patternFlowUdpSrcPort) Random() PatternFlowUdpSrcPortRandom {
	if obj.obj.Random == nil {
		obj.setChoice(PatternFlowUdpSrcPortChoice.RANDOM)
	}
	if obj.randomHolder == nil {
		obj.randomHolder = &patternFlowUdpSrcPortRandom{obj: obj.obj.Random}
	}
...
// description is TBD
// Random returns a PatternFlowUdpSrcPortRandom
func (obj *patternFlowUdpSrcPort) HasRandom() bool {
	return obj.obj.Random != nil
}

// description is TBD
// SetRandom sets the PatternFlowUdpSrcPortRandom value in the PatternFlowUdpSrcPort object
func (obj *patternFlowUdpSrcPort) SetRandom(value PatternFlowUdpSrcPortRandom) PatternFlowUdpSrcPort {
	obj.setChoice(PatternFlowUdpSrcPortChoice.RANDOM)
	obj.randomHolder = nil
...
func (obj *patternFlowUdpSrcPort) setDefault() {
	...
	if obj.obj.Random != nil {
		choices_set += 1
		choice = PatternFlowUdpSrcPortChoice.RANDOM
	}
	if choices_set == 0 {
