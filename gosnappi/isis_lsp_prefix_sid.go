...
type IsisLspPrefixSid interface {
	...
	setDefault()
	// Sid returns uint32, set in IsisLspPrefixSid.
	Sid() uint32
	// SetSid assigns uint32 provided by user to IsisLspPrefixSid
	SetSid(value uint32) IsisLspPrefixSid
	// HasSid checks if Sid has been set in IsisLspPrefixSid
	HasSid() bool
...
func (obj *isisLspPrefixSid) Sid() uint32 {
...
// SID/Index is the SID/Label value associated  with the IGP Prefix segment attached to the specific IPv4 or IPv6 prefix.
// Sid returns a uint32
func (obj *isisLspPrefixSid) HasSid() bool {
	return obj.obj.Sid != nil
}

// SID/Index is the SID/Label value associated  with the IGP Prefix segment attached to the specific IPv4 or IPv6 prefix.
// SetSid sets the uint32 value in the IsisLspPrefixSid object
func (obj *isisLspPrefixSid) SetSid(value uint32) IsisLspPrefixSid {
