...
type marshalPatternFlowGtpv1NextExtensionHeaderTypeCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpv1NextExtensionHeaderTypeCounter to raw JSON text
...
func (m *marshalpatternFlowGtpv1NextExtensionHeaderTypeCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowGtpv1NextExtensionHeaderTypeCounter) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.Count != nil {
		...
		if *obj.obj.Count > 255 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("0 <= PatternFlowGtpv1NextExtensionHeaderTypeCounter.Count <= 255 but Got %d", *obj.obj.Count))
		}
