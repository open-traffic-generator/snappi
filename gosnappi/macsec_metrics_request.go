...
type MacsecMetricsRequest interface {
	...
	setDefault()
	// SecyNames returns []string, set in MacsecMetricsRequest.
	SecyNames() []string
	// SetSecyNames assigns []string provided by user to MacsecMetricsRequest
	SetSecyNames(value []string) MacsecMetricsRequest
...
//
// SecyNames returns a []string
func (obj *macsecMetricsRequest) SecyNames() []string {
	if obj.obj.SecyNames == nil {
		obj.obj.SecyNames = make([]string, 0)
	}
	return obj.obj.SecyNames
}
...
// - /components/schemas/Macsec/properties/name
//
// SetSecyNames sets the []string value in the MacsecMetricsRequest object
func (obj *macsecMetricsRequest) SetSecyNames(value []string) MacsecMetricsRequest {

	if obj.obj.SecyNames == nil {
		obj.obj.SecyNames = make([]string, 0)
	}
	obj.obj.SecyNames = value
...
// The list of column names that the returned result set will contain. If the list is empty then all columns will be returned except for any result_groups. The name of the secY cannot be excluded.
