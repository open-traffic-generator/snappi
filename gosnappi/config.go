...
type Config interface {
	...
	// Metadata returns ConfigMetadata, set in Config.
	...
	// SetMetadata assigns ConfigMetadata provided by user to Config.
	// ConfigMetadata is this optional container can be used to specify additional information about the test and specific
	// configuration being applied via the set_config api.
	// It can be used to correlate logs generated by the test tool to particular test being run by being logged
	// as part of the information recorded in the test tool.
	...
	// for every set_config done as part of the test . Or the timestamp of the set_config api call on the
	// client can be recorded as a tag-value pair.
	SetMetadata(value ConfigMetadata) Config
	// HasMetadata checks if Metadata has been set in Config
	HasMetadata() bool
	setNil()
}
...
// description is TBD
// Metadata returns a ConfigMetadata
func (obj *config) Metadata() ConfigMetadata {
	if obj.obj.Metadata == nil {
		obj.obj.Metadata = NewConfigMetadata().msg()
	}
	if obj.metadataHolder == nil {
		obj.metadataHolder = &configMetadata{obj: obj.obj.Metadata}
	}
	return obj.metadataHolder
}

// description is TBD
// Metadata returns a ConfigMetadata
func (obj *config) HasMetadata() bool {
	return obj.obj.Metadata != nil
}

// description is TBD
// SetMetadata sets the ConfigMetadata value in the Config object
func (obj *config) SetMetadata(value ConfigMetadata) Config {

	obj.metadataHolder = nil
	obj.obj.Metadata = value.msg()
...
func (obj *config) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.Metadata != nil {
		...
		obj.Metadata().validateObj(vObj, set_default)
	}
