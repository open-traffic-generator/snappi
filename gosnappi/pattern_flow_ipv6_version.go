...
func (obj *patternFlowIpv6Version) setDefault() {
	...
	var choice PatternFlowIpv6VersionChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowIpv6VersionChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowIpv6VersionChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowIpv6VersionChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowIpv6VersionChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowIpv6Version")
			}
		} else {
			intVal := otg.PatternFlowIpv6Version_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowIpv6Version_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
