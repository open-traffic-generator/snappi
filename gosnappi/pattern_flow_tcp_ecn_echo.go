...
func (obj *patternFlowTcpEcnEcho) setDefault() {
	...
	var choice PatternFlowTcpEcnEchoChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowTcpEcnEchoChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowTcpEcnEchoChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowTcpEcnEchoChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowTcpEcnEchoChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowTcpEcnEcho")
			}
		} else {
			intVal := otg.PatternFlowTcpEcnEcho_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowTcpEcnEcho_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
