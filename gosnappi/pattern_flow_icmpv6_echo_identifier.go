...
type marshalPatternFlowIcmpv6EchoIdentifier interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowIcmpv6EchoIdentifier to raw JSON text
...
func (m *marshalpatternFlowIcmpv6EchoIdentifier) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowIcmpv6EchoIdentifier) setDefault() {
	...
	var choice PatternFlowIcmpv6EchoIdentifierChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowIcmpv6EchoIdentifierChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowIcmpv6EchoIdentifierChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowIcmpv6EchoIdentifierChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowIcmpv6EchoIdentifierChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowIcmpv6EchoIdentifier")
			}
		} else {
			intVal := otg.PatternFlowIcmpv6EchoIdentifier_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowIcmpv6EchoIdentifier_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
