...
type marshalPatternFlowSnmpv2CVariableBindingValueIpAddressValue interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowSnmpv2CVariableBindingValueIpAddressValue to raw JSON text
...
func (m *marshalpatternFlowSnmpv2CVariableBindingValueIpAddressValue) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
