...
type marshalPatternFlowGtpv1NextExtensionHeaderType interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpv1NextExtensionHeaderType to raw JSON text
...
func (m *marshalpatternFlowGtpv1NextExtensionHeaderType) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
