...
type patternFlowTcpDstPort struct {
	...
	randomHolder     PatternFlowTcpDstPortRandom
}
...
type marshalPatternFlowTcpDstPort interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowTcpDstPort to raw JSON text
...
func (m *marshalpatternFlowTcpDstPort) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
type PatternFlowTcpDstPort interface {
	...
	// Random returns PatternFlowTcpDstPortRandom, set in PatternFlowTcpDstPort.
	// PatternFlowTcpDstPortRandom is integer random pattern
	Random() PatternFlowTcpDstPortRandom
	// SetRandom assigns PatternFlowTcpDstPortRandom provided by user to PatternFlowTcpDstPort.
	// PatternFlowTcpDstPortRandom is integer random pattern
	SetRandom(value PatternFlowTcpDstPortRandom) PatternFlowTcpDstPort
	// HasRandom checks if Random has been set in PatternFlowTcpDstPort
	HasRandom() bool
	setNil()
}
...
var PatternFlowTcpDstPortChoice = struct {
	...
	RANDOM    PatternFlowTcpDstPortChoiceEnum
}{
	...
	RANDOM:    PatternFlowTcpDstPortChoiceEnum("random"),
}
...
func (obj *patternFlowTcpDstPort) setChoice(value PatternFlowTcpDstPortChoiceEnum) PatternFlowTcpDstPort {
	...
	if value == PatternFlowTcpDstPortChoice.RANDOM {
		obj.obj.Random = NewPatternFlowTcpDstPortRandom().msg()
	}
...
// description is TBD
// Random returns a PatternFlowTcpDstPortRandom
func (obj *patternFlowTcpDstPort) Random() PatternFlowTcpDstPortRandom {
	if obj.obj.Random == nil {
		obj.setChoice(PatternFlowTcpDstPortChoice.RANDOM)
	}
	if obj.randomHolder == nil {
		obj.randomHolder = &patternFlowTcpDstPortRandom{obj: obj.obj.Random}
	}
...
// description is TBD
// Random returns a PatternFlowTcpDstPortRandom
func (obj *patternFlowTcpDstPort) HasRandom() bool {
	return obj.obj.Random != nil
}

// description is TBD
// SetRandom sets the PatternFlowTcpDstPortRandom value in the PatternFlowTcpDstPort object
func (obj *patternFlowTcpDstPort) SetRandom(value PatternFlowTcpDstPortRandom) PatternFlowTcpDstPort {
	obj.setChoice(PatternFlowTcpDstPortChoice.RANDOM)
	obj.randomHolder = nil
...
func (obj *patternFlowTcpDstPort) setDefault() {
	...
	if obj.obj.Random != nil {
		choices_set += 1
		choice = PatternFlowTcpDstPortChoice.RANDOM
	}
	if choices_set == 0 {
