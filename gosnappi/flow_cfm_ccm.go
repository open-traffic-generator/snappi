...
type FlowCfmCcm interface {
	...
	setDefault()
	// Flags returns FlowCfmCcmFlags, set in FlowCfmCcm.
	// FlowCfmCcmFlags is cCM flags byte has RDI and CCM Interval.
	Flags() FlowCfmCcmFlags
	// SetFlags assigns FlowCfmCcmFlags provided by user to FlowCfmCcm.
	// FlowCfmCcmFlags is cCM flags byte has RDI and CCM Interval.
	SetFlags(value FlowCfmCcmFlags) FlowCfmCcm
	...
	// PatternFlowCfmCcmMaEndpointIdentifier is maintenance Association End Point Identifier (MEP ID). Unique within the MA. Range 1-8191 per IEEE 802.1Q-2018 Section 12.14.6.3.2.
	...
	// AppendEndTlv returns bool, set in FlowCfmCcm.
	AppendEndTlv() bool
	// SetAppendEndTlv assigns bool provided by user to FlowCfmCcm
	SetAppendEndTlv(value bool) FlowCfmCcm
	// HasAppendEndTlv checks if AppendEndTlv has been set in FlowCfmCcm
	HasAppendEndTlv() bool
	setNil()
}

// description is TBD
// Flags returns a FlowCfmCcmFlags
func (obj *flowCfmCcm) Flags() FlowCfmCcmFlags {
	if obj.obj.Flags == nil {
		obj.obj.Flags = NewFlowCfmCcmFlags().msg()
	}
	if obj.flagsHolder == nil {
		obj.flagsHolder = &flowCfmCcmFlags{obj: obj.obj.Flags}
	}
...
// description is TBD
// SetFlags sets the FlowCfmCcmFlags value in the FlowCfmCcm object
func (obj *flowCfmCcm) SetFlags(value FlowCfmCcmFlags) FlowCfmCcm {
...
func (obj *flowCfmCcm) AppendEndTlv() bool {
...
// When true, the implementation appends an End TLV (Type 0, IEEE 802.1Q-2018 Table 21-17) after all TLVs in the tlvs list. Set to false only when testing DUT behaviour with a deliberately missing End TLV.
// AppendEndTlv returns a bool
func (obj *flowCfmCcm) HasAppendEndTlv() bool {
	return obj.obj.AppendEndTlv != nil
}

// When true, the implementation appends an End TLV (Type 0, IEEE 802.1Q-2018 Table 21-17) after all TLVs in the tlvs list. Set to false only when testing DUT behaviour with a deliberately missing End TLV.
// SetAppendEndTlv sets the bool value in the FlowCfmCcm object
func (obj *flowCfmCcm) SetAppendEndTlv(value bool) FlowCfmCcm {
