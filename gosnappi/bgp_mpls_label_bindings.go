...
// To advertise multiple labels for an address prefix, the BGP capabilities device.bgp.capablity.ipv4_mpls_multi/bgp.capablity.ipv6_mpls_multi etc. to be configured first.
