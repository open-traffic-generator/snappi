...
type marshalPatternFlowSnmpv2CBulkPDUMaxRepetitionsCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowSnmpv2CBulkPDUMaxRepetitionsCounter to raw JSON text
...
func (m *marshalpatternFlowSnmpv2CBulkPDUMaxRepetitionsCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
