...
type Ospfv3InterfaceAdvanced interface {
	...
	HasLinkMetric() bool
	// Priority returns uint32, set in Ospfv3InterfaceAdvanced.
	Priority() uint32
	// SetPriority assigns uint32 provided by user to Ospfv3InterfaceAdvanced
	SetPriority(value uint32) Ospfv3InterfaceAdvanced
	// HasPriority checks if Priority has been set in Ospfv3InterfaceAdvanced
	HasPriority() bool
...
func (obj *ospfv3InterfaceAdvanced) Priority() uint32 {
...
// The default is 0, which indicates that the router will not participate in the DR election process.
// Priority returns a uint32
func (obj *ospfv3InterfaceAdvanced) HasPriority() bool {
...
// This value is used in Hello packets for the Designated Router (DR) election process.
// The default is 0, which indicates that the router will not participate in the DR election process.
// SetPriority sets the uint32 value in the Ospfv3InterfaceAdvanced object
func (obj *ospfv3InterfaceAdvanced) SetPriority(value uint32) Ospfv3InterfaceAdvanced {
...
func (obj *ospfv3InterfaceAdvanced) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.Priority != nil {
		...
		if *obj.obj.Priority > 255 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("0 <= Ospfv3InterfaceAdvanced.Priority <= 255 but Got %d", *obj.obj.Priority))
		}
