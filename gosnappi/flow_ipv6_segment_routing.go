...
type flowIpv6SegmentRouting struct {
	...
	tlvsHolder         FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
}
...
type FlowIpv6SegmentRouting interface {
	...
	// Tlvs returns FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIterIter, set in FlowIpv6SegmentRouting
	Tlvs() FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
	setNil()
}
...
// description is TBD
// Tlvs returns a []FlowIpv6SegmentRoutingTlvs
func (obj *flowIpv6SegmentRouting) Tlvs() FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	if len(obj.obj.Tlvs) == 0 {
		obj.obj.Tlvs = []*otg.FlowIpv6SegmentRoutingTlvs{}
	}
	if obj.tlvsHolder == nil {
		obj.tlvsHolder = newFlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter(&obj.obj.Tlvs).setMsg(obj)
	}
	return obj.tlvsHolder
}

type flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter struct {
	obj                             *flowIpv6SegmentRouting
	flowIpv6SegmentRoutingTlvsSlice []FlowIpv6SegmentRoutingTlvs
	fieldPtr                        *[]*otg.FlowIpv6SegmentRoutingTlvs
}

func newFlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter(ptr *[]*otg.FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	return &flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter{fieldPtr: ptr}
}

type FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter interface {
	setMsg(*flowIpv6SegmentRouting) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
	Items() []FlowIpv6SegmentRoutingTlvs
	Add() FlowIpv6SegmentRoutingTlvs
	Append(items ...FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
	Set(index int, newObj FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
	Clear() FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
	clearHolderSlice() FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
	appendHolderSlice(item FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter
}

func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) setMsg(msg *flowIpv6SegmentRouting) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	obj.clearHolderSlice()
	for _, val := range *obj.fieldPtr {
		obj.appendHolderSlice(&flowIpv6SegmentRoutingTlvs{obj: val})
	}
	obj.obj = msg
	return obj
}

func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) Items() []FlowIpv6SegmentRoutingTlvs {
	return obj.flowIpv6SegmentRoutingTlvsSlice
}

func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) Add() FlowIpv6SegmentRoutingTlvs {
	newObj := &otg.FlowIpv6SegmentRoutingTlvs{}
	*obj.fieldPtr = append(*obj.fieldPtr, newObj)
	newLibObj := &flowIpv6SegmentRoutingTlvs{obj: newObj}
	newLibObj.setDefault()
	obj.flowIpv6SegmentRoutingTlvsSlice = append(obj.flowIpv6SegmentRoutingTlvsSlice, newLibObj)
	return newLibObj
}

func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) Append(items ...FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	for _, item := range items {
		newObj := item.msg()
		*obj.fieldPtr = append(*obj.fieldPtr, newObj)
		obj.flowIpv6SegmentRoutingTlvsSlice = append(obj.flowIpv6SegmentRoutingTlvsSlice, item)
	}
	return obj
}

func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) Set(index int, newObj FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	(*obj.fieldPtr)[index] = newObj.msg()
	obj.flowIpv6SegmentRoutingTlvsSlice[index] = newObj
	return obj
}
func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) Clear() FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	if len(*obj.fieldPtr) > 0 {
		*obj.fieldPtr = []*otg.FlowIpv6SegmentRoutingTlvs{}
		obj.flowIpv6SegmentRoutingTlvsSlice = []FlowIpv6SegmentRoutingTlvs{}
	}
	return obj
}
func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) clearHolderSlice() FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	if len(obj.flowIpv6SegmentRoutingTlvsSlice) > 0 {
		obj.flowIpv6SegmentRoutingTlvsSlice = []FlowIpv6SegmentRoutingTlvs{}
	}
	return obj
}
func (obj *flowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter) appendHolderSlice(item FlowIpv6SegmentRoutingTlvs) FlowIpv6SegmentRoutingFlowIpv6SegmentRoutingTlvsIter {
	obj.flowIpv6SegmentRoutingTlvsSlice = append(obj.flowIpv6SegmentRoutingTlvsSlice, item)
	return obj
}
	...
	if len(obj.obj.Tlvs) != 0 {
		...
		if set_default {
			...
			for _, item := range obj.obj.Tlvs {
				obj.Tlvs().appendHolderSlice(&flowIpv6SegmentRoutingTlvs{obj: item})
			}
		}
