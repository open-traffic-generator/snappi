...
type RouteMplsLabelIndex interface {
	...
	HasStart() bool
	// Max returns uint32, set in RouteMplsLabelIndex.
	Max() uint32
	// SetMax assigns uint32 provided by user to RouteMplsLabelIndex
	SetMax(value uint32) RouteMplsLabelIndex
	// HasMax checks if Max has been set in RouteMplsLabelIndex
	HasMax() bool
...
// The maximum numbers of Label Index in the range.
// Max returns a uint32
func (obj *routeMplsLabelIndex) Max() uint32 {
...
// The maximum numbers of Label Index in the range.
// Max returns a uint32
func (obj *routeMplsLabelIndex) HasMax() bool {
	return obj.obj.Max != nil
}

// The maximum numbers of Label Index in the range.
// SetMax sets the uint32 value in the RouteMplsLabelIndex object
func (obj *routeMplsLabelIndex) SetMax(value uint32) RouteMplsLabelIndex {
...
func (obj *routeMplsLabelIndex) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.Start != nil {
		...
		if *obj.obj.Start < 10 || *obj.obj.Start > 1048575 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("10 <= RouteMplsLabelIndex.Start <= 1048575 but Got %d", *obj.obj.Start))
		}
	...
	if obj.obj.Max != nil {
		...
		if *obj.obj.Max < 1 || *obj.obj.Max > 1048575 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("1 <= RouteMplsLabelIndex.Max <= 1048575 but Got %d", *obj.obj.Max))
		}
