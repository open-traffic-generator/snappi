...
type MacsecRxScStaticKey interface {
	...
	HasDutSystemId() bool
	// DutSciPortId returns int32, set in MacsecRxScStaticKey.
	DutSciPortId() int32
	// SetDutSciPortId assigns int32 provided by user to MacsecRxScStaticKey
	SetDutSciPortId(value int32) MacsecRxScStaticKey
	...
	// ReplayWindow returns int32, set in MacsecRxScStaticKey.
	ReplayWindow() int32
	// SetReplayWindow assigns int32 provided by user to MacsecRxScStaticKey
	SetReplayWindow(value int32) MacsecRxScStaticKey
...
func (obj *macsecRxScStaticKey) DutSciPortId() int32 {
...
// DUT SCI Port ID.
// SetDutSciPortId sets the int32 value in the MacsecRxScStaticKey object
func (obj *macsecRxScStaticKey) SetDutSciPortId(value int32) MacsecRxScStaticKey {
...
func (obj *macsecRxScStaticKey) ReplayWindow() int32 {
...
// Replay window size.
// SetReplayWindow sets the int32 value in the MacsecRxScStaticKey object
func (obj *macsecRxScStaticKey) SetReplayWindow(value int32) MacsecRxScStaticKey {
