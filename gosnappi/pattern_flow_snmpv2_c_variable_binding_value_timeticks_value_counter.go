...
type marshalPatternFlowSnmpv2CVariableBindingValueTimeticksValueCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowSnmpv2CVariableBindingValueTimeticksValueCounter to raw JSON text
...
func (m *marshalpatternFlowSnmpv2CVariableBindingValueTimeticksValueCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
