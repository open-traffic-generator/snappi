...
type marshalPatternFlowGtpv1Teid interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpv1Teid to raw JSON text
...
func (m *marshalpatternFlowGtpv1Teid) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowGtpv1Teid) setDefault() {
	...
	var choice PatternFlowGtpv1TeidChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowGtpv1TeidChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowGtpv1TeidChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowGtpv1TeidChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowGtpv1TeidChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowGtpv1Teid")
			}
		} else {
			intVal := otg.PatternFlowGtpv1Teid_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowGtpv1Teid_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
