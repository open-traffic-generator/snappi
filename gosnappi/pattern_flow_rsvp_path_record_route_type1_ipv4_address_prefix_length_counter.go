...
type marshalPatternFlowRSVPPathRecordRouteType1Ipv4AddressPrefixLengthCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowRSVPPathRecordRouteType1Ipv4AddressPrefixLengthCounter to raw JSON text
...
func (m *marshalpatternFlowRSVPPathRecordRouteType1Ipv4AddressPrefixLengthCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
