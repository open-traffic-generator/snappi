...
type DeviceBmpServerV4 interface {
	...
	HasConnection() bool
	// DiscardAdjRib returns bool, set in DeviceBmpServerV4.
	DiscardAdjRib() bool
	// SetDiscardAdjRib assigns bool provided by user to DeviceBmpServerV4
	SetDiscardAdjRib(value bool) DeviceBmpServerV4
	// HasDiscardAdjRib checks if DiscardAdjRib has been set in DeviceBmpServerV4
	HasDiscardAdjRib() bool
...
// DiscardAdjRib returns a bool
func (obj *deviceBmpServerV4) DiscardAdjRib() bool {

	return *obj.obj.DiscardAdjRib

}

// If enabled, discard the BGP route information sent by the remote BMP client in BMP Monitoring messages.
// DiscardAdjRib returns a bool
func (obj *deviceBmpServerV4) HasDiscardAdjRib() bool {
	return obj.obj.DiscardAdjRib != nil
}

// If enabled, discard the BGP route information sent by the remote BMP client in BMP Monitoring messages.
// SetDiscardAdjRib sets the bool value in the DeviceBmpServerV4 object
func (obj *deviceBmpServerV4) SetDiscardAdjRib(value bool) DeviceBmpServerV4 {

	obj.obj.DiscardAdjRib = &value
	return obj
}
...
func (obj *deviceBmpServerV4) setDefault() {
	if obj.obj.DiscardAdjRib == nil {
		obj.SetDiscardAdjRib(false)
	}
