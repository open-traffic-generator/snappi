...
type configDelete struct {
	...
	resourcesHolder ConfigDeleteConfigDeleteResourceIter
}
...
type ConfigDelete interface {
	...
	setDefault()
	// Resources returns ConfigDeleteConfigDeleteResourceIterIter, set in ConfigDelete
	Resources() ConfigDeleteConfigDeleteResourceIter
	setNil()
}

// Configuration resources of various types to be deleted.
// Resources returns a []ConfigDeleteResource
func (obj *configDelete) Resources() ConfigDeleteConfigDeleteResourceIter {
	if len(obj.obj.Resources) == 0 {
		obj.obj.Resources = []*otg.ConfigDeleteResource{}
	}
	if obj.resourcesHolder == nil {
		obj.resourcesHolder = newConfigDeleteConfigDeleteResourceIter(&obj.obj.Resources).setMsg(obj)
	}
	...
	if len(obj.obj.Resources) != 0 {
		...
		if set_default {
			...
			for _, item := range obj.obj.Resources {
				obj.Resources().appendHolderSlice(&configDeleteResource{obj: item})
			}
		}
