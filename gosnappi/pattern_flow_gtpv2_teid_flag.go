...
type marshalPatternFlowGtpv2TeidFlag interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpv2TeidFlag to raw JSON text
...
func (m *marshalpatternFlowGtpv2TeidFlag) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowGtpv2TeidFlag) setDefault() {
	...
	var choice PatternFlowGtpv2TeidFlagChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowGtpv2TeidFlagChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowGtpv2TeidFlagChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowGtpv2TeidFlagChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowGtpv2TeidFlagChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowGtpv2TeidFlag")
			}
		} else {
			intVal := otg.PatternFlowGtpv2TeidFlag_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowGtpv2TeidFlag_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
