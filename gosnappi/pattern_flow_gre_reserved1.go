...
func (obj *patternFlowGreReserved1) setDefault() {
	...
	var choice PatternFlowGreReserved1ChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowGreReserved1Choice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowGreReserved1Choice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowGreReserved1Choice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowGreReserved1Choice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowGreReserved1")
			}
		} else {
			intVal := otg.PatternFlowGreReserved1_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowGreReserved1_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
