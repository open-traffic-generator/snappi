...
type marshalPatternFlowSnmpv2CBulkPDUNonRepeaters interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowSnmpv2CBulkPDUNonRepeaters to raw JSON text
...
func (m *marshalpatternFlowSnmpv2CBulkPDUNonRepeaters) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowSnmpv2CBulkPDUNonRepeaters) setDefault() {
	...
	var choice PatternFlowSnmpv2CBulkPDUNonRepeatersChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowSnmpv2CBulkPDUNonRepeatersChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowSnmpv2CBulkPDUNonRepeatersChoice.VALUES
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowSnmpv2CBulkPDUNonRepeaters")
			}
		} else {
			intVal := otg.PatternFlowSnmpv2CBulkPDUNonRepeaters_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowSnmpv2CBulkPDUNonRepeaters_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
