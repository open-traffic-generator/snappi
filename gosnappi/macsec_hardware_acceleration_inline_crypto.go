...
func (obj *macsecHardwareAccelerationInlineCrypto) setDefault() {
	...
	if obj.obj.MaxCaCount == nil {
		obj.SetMaxCaCount(MacsecHardwareAccelerationInlineCryptoMaxCaCount.TWO_FIFTY_SIX)
