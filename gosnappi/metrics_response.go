...
type metricsResponse struct {
	...
	rocev2Ipv4MetricsHolder   MetricsResponseRoCEv2IPv4MetricIter
...
type MetricsResponse interface {
	...
	// Rocev2Ipv4Metrics returns MetricsResponseRoCEv2IPv4MetricIterIter, set in MetricsResponse
	Rocev2Ipv4Metrics() MetricsResponseRoCEv2IPv4MetricIter
...
func (obj *metricsResponse) setChoice(value MetricsResponseChoiceEnum) MetricsResponse {
	...
	if value == MetricsResponseChoice.ROCEV2_IPV4_METRICS {
		obj.obj.Rocev2Ipv4Metrics = []*otg.RoCEv2IPv4Metric{}
	}
...
// description is TBD
// Rocev2Ipv4Metrics returns a []RoCEv2IPv4Metric
func (obj *metricsResponse) Rocev2Ipv4Metrics() MetricsResponseRoCEv2IPv4MetricIter {
	...
	if obj.rocev2Ipv4MetricsHolder == nil {
		obj.rocev2Ipv4MetricsHolder = newMetricsResponseRoCEv2IPv4MetricIter(&obj.obj.Rocev2Ipv4Metrics).setMsg(obj)
	}
	return obj.rocev2Ipv4MetricsHolder
}

type metricsResponseRoCEv2IPv4MetricIter struct {
	obj                   *metricsResponse
	roCEv2IPv4MetricSlice []RoCEv2IPv4Metric
	fieldPtr              *[]*otg.RoCEv2IPv4Metric
}

func newMetricsResponseRoCEv2IPv4MetricIter(ptr *[]*otg.RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter {
	return &metricsResponseRoCEv2IPv4MetricIter{fieldPtr: ptr}
}

type MetricsResponseRoCEv2IPv4MetricIter interface {
	setMsg(*metricsResponse) MetricsResponseRoCEv2IPv4MetricIter
	Items() []RoCEv2IPv4Metric
	Add() RoCEv2IPv4Metric
	Append(items ...RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter
	Set(index int, newObj RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter
	Clear() MetricsResponseRoCEv2IPv4MetricIter
	clearHolderSlice() MetricsResponseRoCEv2IPv4MetricIter
	appendHolderSlice(item RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter
}

func (obj *metricsResponseRoCEv2IPv4MetricIter) setMsg(msg *metricsResponse) MetricsResponseRoCEv2IPv4MetricIter {
	obj.clearHolderSlice()
	for _, val := range *obj.fieldPtr {
		obj.appendHolderSlice(&roCEv2IPv4Metric{obj: val})
	}
	obj.obj = msg
	return obj
}

func (obj *metricsResponseRoCEv2IPv4MetricIter) Items() []RoCEv2IPv4Metric {
	return obj.roCEv2IPv4MetricSlice
}

func (obj *metricsResponseRoCEv2IPv4MetricIter) Add() RoCEv2IPv4Metric {
	newObj := &otg.RoCEv2IPv4Metric{}
	*obj.fieldPtr = append(*obj.fieldPtr, newObj)
	newLibObj := &roCEv2IPv4Metric{obj: newObj}
	newLibObj.setDefault()
	obj.roCEv2IPv4MetricSlice = append(obj.roCEv2IPv4MetricSlice, newLibObj)
	return newLibObj
}

func (obj *metricsResponseRoCEv2IPv4MetricIter) Append(items ...RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter {
	for _, item := range items {
		newObj := item.msg()
		*obj.fieldPtr = append(*obj.fieldPtr, newObj)
		obj.roCEv2IPv4MetricSlice = append(obj.roCEv2IPv4MetricSlice, item)
	}
	return obj
}

func (obj *metricsResponseRoCEv2IPv4MetricIter) Set(index int, newObj RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter {
	(*obj.fieldPtr)[index] = newObj.msg()
	obj.roCEv2IPv4MetricSlice[index] = newObj
	return obj
}
func (obj *metricsResponseRoCEv2IPv4MetricIter) Clear() MetricsResponseRoCEv2IPv4MetricIter {
	if len(*obj.fieldPtr) > 0 {
		*obj.fieldPtr = []*otg.RoCEv2IPv4Metric{}
		obj.roCEv2IPv4MetricSlice = []RoCEv2IPv4Metric{}
	}
	return obj
}
func (obj *metricsResponseRoCEv2IPv4MetricIter) clearHolderSlice() MetricsResponseRoCEv2IPv4MetricIter {
	if len(obj.roCEv2IPv4MetricSlice) > 0 {
		obj.roCEv2IPv4MetricSlice = []RoCEv2IPv4Metric{}
	}
	return obj
}
func (obj *metricsResponseRoCEv2IPv4MetricIter) appendHolderSlice(item RoCEv2IPv4Metric) MetricsResponseRoCEv2IPv4MetricIter {
	obj.roCEv2IPv4MetricSlice = append(obj.roCEv2IPv4MetricSlice, item)
	return obj
}

// description is TBD
// Rocev2Ipv6Metrics returns a []RoCEv2IPv6Metric
func (obj *metricsResponse) Rocev2Ipv6Metrics() MetricsResponseRoCEv2IPv6MetricIter {
	if len(obj.obj.Rocev2Ipv6Metrics) == 0 {
		obj.setChoice(MetricsResponseChoice.ROCEV2_IPV6_METRICS)
	}
	if obj.rocev2Ipv6MetricsHolder == nil {
		obj.rocev2Ipv6MetricsHolder = newMetricsResponseRoCEv2IPv6MetricIter(&obj.obj.Rocev2Ipv6Metrics).setMsg(obj)
	}
	return obj.rocev2Ipv6MetricsHolder
}

type metricsResponseRoCEv2IPv6MetricIter struct {
	obj                   *metricsResponse
	roCEv2IPv6MetricSlice []RoCEv2IPv6Metric
	fieldPtr              *[]*otg.RoCEv2IPv6Metric
}

func newMetricsResponseRoCEv2IPv6MetricIter(ptr *[]*otg.RoCEv2IPv6Metric) MetricsResponseRoCEv2IPv6MetricIter {
	return &metricsResponseRoCEv2IPv6MetricIter{fieldPtr: ptr}
}

type MetricsResponseRoCEv2IPv6MetricIter interface {
	setMsg(*metricsResponse) MetricsResponseRoCEv2IPv6MetricIter
	Items() []RoCEv2IPv6Metric
	Add() RoCEv2IPv6Metric
	Append(items ...RoCEv2IPv6Metric) MetricsResponseRoCEv2IPv6MetricIter
	Set(index int, newObj RoCEv2IPv6Metric) MetricsResponseRoCEv2IPv6MetricIter
	Clear() MetricsResponseRoCEv2IPv6MetricIter
	clearHolderSlice() MetricsResponseRoCEv2IPv6MetricIter
	appendHolderSlice(item RoCEv2IPv6Metric) MetricsResponseRoCEv2IPv6MetricIter
}

func (obj *metricsResponseRoCEv2IPv6MetricIter) setMsg(msg *metricsResponse) MetricsResponseRoCEv2IPv6MetricIter {
	obj.clearHolderSlice()
	for _, val := range *obj.fieldPtr {
		obj.appendHolderSlice(&roCEv2IPv6Metric{obj: val})
	}
	obj.obj = msg
	return obj
}

func (obj *metricsResponseRoCEv2IPv6MetricIter) Items() []RoCEv2IPv6Metric {
	return obj.roCEv2IPv6MetricSlice
}

func (obj *metricsResponseRoCEv2IPv6MetricIter) Add() RoCEv2IPv6Metric {
	newObj := &otg.RoCEv2IPv6Metric{}
	*obj.fieldPtr = append(*obj.fieldPtr, newObj)
	newLibObj := &roCEv2IPv6Metric{obj: newObj}
	newLibObj.setDefault()
	obj.roCEv2IPv6MetricSlice = append(obj.roCEv2IPv6MetricSlice, newLibObj)
	return newLibObj
}

func (obj *metricsResponseRoCEv2IPv6MetricIter) Append(items ...RoCEv2IPv6Metric) MetricsResponseRoCEv2IPv6MetricIter {
	for _, item := range items {
		newObj := item.msg()
		*obj.fieldPtr = append(*obj.fieldPtr, newObj)
...
func (obj *metricsResponseRoCEv2IPv6MetricIter) Set(index int, newObj RoCEv2IPv6Metric) MetricsResponseRoCEv2IPv6MetricIter {
	(*obj.fieldPtr)[index] = newObj.msg()
	obj.roCEv2IPv6MetricSlice[index] = newObj
	return obj
}
func (obj *metricsResponseRoCEv2IPv6MetricIter) Clear() MetricsResponseRoCEv2IPv6MetricIter {
	if len(*obj.fieldPtr) > 0 {
		*obj.fieldPtr = []*otg.RoCEv2IPv6Metric{}
		obj.roCEv2IPv6MetricSlice = []RoCEv2IPv6Metric{}
	}
	return obj
}
func (obj *metricsResponseRoCEv2IPv6MetricIter) clearHolderSlice() MetricsResponseRoCEv2IPv6MetricIter {
	if len(obj.roCEv2IPv6MetricSlice) > 0 {
		obj.roCEv2IPv6MetricSlice = []RoCEv2IPv6Metric{}
	}
	return obj
}
...
func (obj *metricsResponse) validateObj(vObj *validation, set_default bool) {
	...
	if len(obj.obj.Rocev2Ipv4Metrics) != 0 {
		...
		if set_default {
			...
			for _, item := range obj.obj.Rocev2Ipv4Metrics {
				obj.Rocev2Ipv4Metrics().appendHolderSlice(&roCEv2IPv4Metric{obj: item})
			}
		}
	...
	if len(obj.obj.Rocev2Ipv6Metrics) != 0 {
		...
		if set_default {
			obj.Rocev2Ipv6Metrics().clearHolderSlice()
			for _, item := range obj.obj.Rocev2Ipv6Metrics {
				obj.Rocev2Ipv6Metrics().appendHolderSlice(&roCEv2IPv6Metric{obj: item})
			}
		}
