...
type DeviceBmpServerV6 interface {
	...
	HasConnection() bool
	// DiscardAdjRib returns bool, set in DeviceBmpServerV6.
	DiscardAdjRib() bool
	// SetDiscardAdjRib assigns bool provided by user to DeviceBmpServerV6
	SetDiscardAdjRib(value bool) DeviceBmpServerV6
	// HasDiscardAdjRib checks if DiscardAdjRib has been set in DeviceBmpServerV6
...
func (obj *deviceBmpServerV6) DiscardAdjRib() bool {
...
// If enabled, discard the BGP route information sent by the remote BMP client in BMP Monitoring messages.
// DiscardAdjRib returns a bool
func (obj *deviceBmpServerV6) HasDiscardAdjRib() bool {
	return obj.obj.DiscardAdjRib != nil
}

// If enabled, discard the BGP route information sent by the remote BMP client in BMP Monitoring messages.
// SetDiscardAdjRib sets the bool value in the DeviceBmpServerV6 object
func (obj *deviceBmpServerV6) SetDiscardAdjRib(value bool) DeviceBmpServerV6 {
