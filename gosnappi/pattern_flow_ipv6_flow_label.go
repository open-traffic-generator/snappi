...
type patternFlowIpv6FlowLabel struct {
	...
	randomHolder     PatternFlowIpv6FlowLabelRandom
}
...
type marshalPatternFlowIpv6FlowLabel interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowIpv6FlowLabel to raw JSON text
...
func (m *marshalpatternFlowIpv6FlowLabel) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
type PatternFlowIpv6FlowLabel interface {
	...
	// Random returns PatternFlowIpv6FlowLabelRandom, set in PatternFlowIpv6FlowLabel.
	// PatternFlowIpv6FlowLabelRandom is integer random pattern
	Random() PatternFlowIpv6FlowLabelRandom
	// SetRandom assigns PatternFlowIpv6FlowLabelRandom provided by user to PatternFlowIpv6FlowLabel.
	// PatternFlowIpv6FlowLabelRandom is integer random pattern
	SetRandom(value PatternFlowIpv6FlowLabelRandom) PatternFlowIpv6FlowLabel
	// HasRandom checks if Random has been set in PatternFlowIpv6FlowLabel
	HasRandom() bool
	setNil()
}
...
var PatternFlowIpv6FlowLabelChoice = struct {
	...
	RANDOM    PatternFlowIpv6FlowLabelChoiceEnum
}{
	...
	RANDOM:    PatternFlowIpv6FlowLabelChoiceEnum("random"),
}
...
func (obj *patternFlowIpv6FlowLabel) setChoice(value PatternFlowIpv6FlowLabelChoiceEnum) PatternFlowIpv6FlowLabel {
	...
	if value == PatternFlowIpv6FlowLabelChoice.RANDOM {
		obj.obj.Random = NewPatternFlowIpv6FlowLabelRandom().msg()
	}
...
// description is TBD
// Random returns a PatternFlowIpv6FlowLabelRandom
func (obj *patternFlowIpv6FlowLabel) Random() PatternFlowIpv6FlowLabelRandom {
	if obj.obj.Random == nil {
		obj.setChoice(PatternFlowIpv6FlowLabelChoice.RANDOM)
	}
	if obj.randomHolder == nil {
		obj.randomHolder = &patternFlowIpv6FlowLabelRandom{obj: obj.obj.Random}
	}
...
// description is TBD
// Random returns a PatternFlowIpv6FlowLabelRandom
func (obj *patternFlowIpv6FlowLabel) HasRandom() bool {
	return obj.obj.Random != nil
}

// description is TBD
// SetRandom sets the PatternFlowIpv6FlowLabelRandom value in the PatternFlowIpv6FlowLabel object
func (obj *patternFlowIpv6FlowLabel) SetRandom(value PatternFlowIpv6FlowLabelRandom) PatternFlowIpv6FlowLabel {
	obj.setChoice(PatternFlowIpv6FlowLabelChoice.RANDOM)
	obj.randomHolder = nil
...
func (obj *patternFlowIpv6FlowLabel) setDefault() {
	...
	if obj.obj.Random != nil {
		choices_set += 1
		choice = PatternFlowIpv6FlowLabelChoice.RANDOM
	}
	if choices_set == 0 {
