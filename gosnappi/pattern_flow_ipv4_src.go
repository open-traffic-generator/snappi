...
type patternFlowIpv4Src struct {
	...
	randomHolder     PatternFlowIpv4SrcRandom
}
...
type marshalPatternFlowIpv4Src interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowIpv4Src to raw JSON text
...
func (m *marshalpatternFlowIpv4Src) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
type PatternFlowIpv4Src interface {
	...
	HasAuto() bool
	// Random returns PatternFlowIpv4SrcRandom, set in PatternFlowIpv4Src.
	// PatternFlowIpv4SrcRandom is ipv4 random pattern
	Random() PatternFlowIpv4SrcRandom
	// SetRandom assigns PatternFlowIpv4SrcRandom provided by user to PatternFlowIpv4Src.
	// PatternFlowIpv4SrcRandom is ipv4 random pattern
	SetRandom(value PatternFlowIpv4SrcRandom) PatternFlowIpv4Src
	// HasRandom checks if Random has been set in PatternFlowIpv4Src
	HasRandom() bool
	setNil()
}
...
var PatternFlowIpv4SrcChoice = struct {
	...
	RANDOM    PatternFlowIpv4SrcChoiceEnum
}{
	...
	RANDOM:    PatternFlowIpv4SrcChoiceEnum("random"),
}
...
func (obj *patternFlowIpv4Src) setChoice(value PatternFlowIpv4SrcChoiceEnum) PatternFlowIpv4Src {
	...
	if value == PatternFlowIpv4SrcChoice.RANDOM {
		obj.obj.Random = NewPatternFlowIpv4SrcRandom().msg()
	}
...
// description is TBD
// Random returns a PatternFlowIpv4SrcRandom
func (obj *patternFlowIpv4Src) Random() PatternFlowIpv4SrcRandom {
	if obj.obj.Random == nil {
		obj.setChoice(PatternFlowIpv4SrcChoice.RANDOM)
	}
	if obj.randomHolder == nil {
		obj.randomHolder = &patternFlowIpv4SrcRandom{obj: obj.obj.Random}
	}
...
// description is TBD
// Random returns a PatternFlowIpv4SrcRandom
func (obj *patternFlowIpv4Src) HasRandom() bool {
	return obj.obj.Random != nil
}

// description is TBD
// SetRandom sets the PatternFlowIpv4SrcRandom value in the PatternFlowIpv4Src object
func (obj *patternFlowIpv4Src) SetRandom(value PatternFlowIpv4SrcRandom) PatternFlowIpv4Src {
	obj.setChoice(PatternFlowIpv4SrcChoice.RANDOM)
	obj.randomHolder = nil
...
func (obj *patternFlowIpv4Src) setDefault() {
	...
	if obj.obj.Random != nil {
		choices_set += 1
		choice = PatternFlowIpv4SrcChoice.RANDOM
	}
	if choices_set == 0 {
