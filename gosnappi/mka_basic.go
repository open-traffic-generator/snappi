...
type MkaBasic interface {
	...
	// MkaBasicKeySource is the container for key source settings.
	...
	// EapolEthernetType returns string, set in MkaBasic.
	EapolEthernetType() string
	// SetEapolEthernetType assigns string provided by user to MkaBasic
	SetEapolEthernetType(value string) MkaBasic
	// HasEapolEthernetType checks if EapolEthernetType has been set in MkaBasic
	HasEapolEthernetType() bool
...
// EAPOL Ethernet type.
// EapolEthernetType returns a string
func (obj *mkaBasic) EapolEthernetType() string {

	return *obj.obj.EapolEthernetType

}

// EAPOL Ethernet type.
// EapolEthernetType returns a string
func (obj *mkaBasic) HasEapolEthernetType() bool {
	return obj.obj.EapolEthernetType != nil
}

// EAPOL Ethernet type.
// SetEapolEthernetType sets the string value in the MkaBasic object
func (obj *mkaBasic) SetEapolEthernetType(value string) MkaBasic {

	obj.obj.EapolEthernetType = &value
	return obj
}
...
func (obj *mkaBasic) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.ActorPriority != nil {
		...
		if len(*obj.obj.ActorPriority) < 1 || len(*obj.obj.ActorPriority) > 2 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf(
					"1 <= length of MkaBasic.ActorPriority <= 2 but Got %d",
	...
	if obj.obj.EapolEthernetType != nil {

		if len(*obj.obj.EapolEthernetType) < 1 || len(*obj.obj.EapolEthernetType) > 4 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf(
					"1 <= length of MkaBasic.EapolEthernetType <= 4 but Got %d",
					len(*obj.obj.EapolEthernetType)))
		}
	...
	if obj.obj.MkaHelloTime != nil {
		...
		if *obj.obj.MkaHelloTime < 500 || *obj.obj.MkaHelloTime > 10000 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("500 <= MkaBasic.MkaHelloTime <= 10000 but Got %d", *obj.obj.MkaHelloTime))
		}
	...
	if obj.obj.MkaLifeTime != nil {
		...
		if *obj.obj.MkaLifeTime < 1 || *obj.obj.MkaLifeTime > 255 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("1 <= MkaBasic.MkaLifeTime <= 255 but Got %d", *obj.obj.MkaLifeTime))
		}
	...
	if obj.obj.PskChainStartTime != nil {
		...
		obj.PskChainStartTime().validateObj(vObj, set_default)
	}
