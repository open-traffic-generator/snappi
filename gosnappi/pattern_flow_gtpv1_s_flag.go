...
type marshalPatternFlowGtpv1SFlag interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpv1SFlag to raw JSON text
...
func (m *marshalpatternFlowGtpv1SFlag) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowGtpv1SFlag) setDefault() {
	...
	var choice PatternFlowGtpv1SFlagChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowGtpv1SFlagChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowGtpv1SFlagChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowGtpv1SFlagChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowGtpv1SFlagChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowGtpv1SFlag")
			}
		} else {
			intVal := otg.PatternFlowGtpv1SFlag_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowGtpv1SFlag_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
