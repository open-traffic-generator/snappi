...
// The list of metric names that the returned result set will contain. If the list is empty then all metrics will be returned. Note: tx_metrics is optional, It is applicable where implementation is able to retrieve transmitter information.
