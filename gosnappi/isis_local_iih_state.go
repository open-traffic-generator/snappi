...
// IsisLocalIIHState is a ISIS Neigbor Information.
type IsisLocalIIHState interface {
	...
	// Tlvs returns IsisIIHTlvs, set in IsisLocalIIHState.
	// IsisIIHTlvs is this contains the list of TLVs present in a IIH PDU.
	Tlvs() IsisIIHTlvs
	// SetTlvs assigns IsisIIHTlvs provided by user to IsisLocalIIHState.
	// IsisIIHTlvs is this contains the list of TLVs present in a IIH PDU.
	SetTlvs(value IsisIIHTlvs) IsisLocalIIHState
	// HasTlvs checks if Tlvs has been set in IsisLocalIIHState
	HasTlvs() bool
	setNil()
}
...
func (obj *isisLocalIIHState) Tlvs() IsisIIHTlvs {
	if obj.obj.Tlvs == nil {
...
// It refers to IIH PDU TLVs container.
// Tlvs returns a IsisIIHTlvs
func (obj *isisLocalIIHState) HasTlvs() bool {
	return obj.obj.Tlvs != nil
}

// It refers to IIH PDU TLVs container.
// SetTlvs sets the IsisIIHTlvs value in the IsisLocalIIHState object
func (obj *isisLocalIIHState) SetTlvs(value IsisIIHTlvs) IsisLocalIIHState {
