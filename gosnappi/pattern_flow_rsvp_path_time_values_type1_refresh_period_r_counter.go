...
type marshalPatternFlowRSVPPathTimeValuesType1RefreshPeriodRCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowRSVPPathTimeValuesType1RefreshPeriodRCounter to raw JSON text
...
func (m *marshalpatternFlowRSVPPathTimeValuesType1RefreshPeriodRCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
