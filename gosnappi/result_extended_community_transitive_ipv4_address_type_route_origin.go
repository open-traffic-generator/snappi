...
type marshalResultExtendedCommunityTransitiveIpv4AddressTypeRouteOrigin interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals ResultExtendedCommunityTransitiveIpv4AddressTypeRouteOrigin to raw JSON text
...
func (m *marshalresultExtendedCommunityTransitiveIpv4AddressTypeRouteOrigin) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
