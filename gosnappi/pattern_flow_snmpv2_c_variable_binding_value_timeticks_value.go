...
type marshalPatternFlowSnmpv2CVariableBindingValueTimeticksValue interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowSnmpv2CVariableBindingValueTimeticksValue to raw JSON text
...
func (m *marshalpatternFlowSnmpv2CVariableBindingValueTimeticksValue) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowSnmpv2CVariableBindingValueTimeticksValue) setDefault() {
	...
	var choice PatternFlowSnmpv2CVariableBindingValueTimeticksValueChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowSnmpv2CVariableBindingValueTimeticksValueChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowSnmpv2CVariableBindingValueTimeticksValueChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowSnmpv2CVariableBindingValueTimeticksValueChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowSnmpv2CVariableBindingValueTimeticksValueChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowSnmpv2CVariableBindingValueTimeticksValue")
			}
		} else {
			intVal := otg.PatternFlowSnmpv2CVariableBindingValueTimeticksValue_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowSnmpv2CVariableBindingValueTimeticksValue_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
