...
type RoCEv2IPv4MetricsRequest interface {
	...
	setDefault()
	// PeerNames returns []string, set in RoCEv2IPv4MetricsRequest.
	PeerNames() []string
	// SetPeerNames assigns []string provided by user to RoCEv2IPv4MetricsRequest
	SetPeerNames(value []string) RoCEv2IPv4MetricsRequest
	// ColumnNames returns []RoCEv2IPv4MetricsRequestColumnNamesEnum, set in RoCEv2IPv4MetricsRequest
	ColumnNames() []RoCEv2IPv4MetricsRequestColumnNamesEnum
	// SetColumnNames assigns []RoCEv2IPv4MetricsRequestColumnNamesEnum provided by user to RoCEv2IPv4MetricsRequest
	SetColumnNames(value []RoCEv2IPv4MetricsRequestColumnNamesEnum) RoCEv2IPv4MetricsRequest
}
...
func (obj *roCEv2IPv4MetricsRequest) PeerNames() []string {
...
// - /components/schemas/RoCEv2.V4peer/properties/name
//
// SetPeerNames sets the []string value in the RoCEv2IPv4MetricsRequest object
func (obj *roCEv2IPv4MetricsRequest) SetPeerNames(value []string) RoCEv2IPv4MetricsRequest {
...
type RoCEv2IPv4MetricsRequestColumnNamesEnum string

// Enum of ColumnNames on RoCEv2IPv4MetricsRequest
var RoCEv2IPv4MetricsRequestColumnNames = struct {
	SESSION_STATE         RoCEv2IPv4MetricsRequestColumnNamesEnum
	QP_CONFUGRED          RoCEv2IPv4MetricsRequestColumnNamesEnum
	QP_UP                 RoCEv2IPv4MetricsRequestColumnNamesEnum
	QP_DOWN               RoCEv2IPv4MetricsRequestColumnNamesEnum
	CONNECT_REQUEST_TX    RoCEv2IPv4MetricsRequestColumnNamesEnum
	CONNECT_REQUEST_RX    RoCEv2IPv4MetricsRequestColumnNamesEnum
	CONNECT_REPLY_TX      RoCEv2IPv4MetricsRequestColumnNamesEnum
	CONNECT_REPLY_RX      RoCEv2IPv4MetricsRequestColumnNamesEnum
	READY_TX              RoCEv2IPv4MetricsRequestColumnNamesEnum
	READY_RX              RoCEv2IPv4MetricsRequestColumnNamesEnum
	DISCONNECT_REQUEST_TX RoCEv2IPv4MetricsRequestColumnNamesEnum
	DISCONNECT_REQUEST_RX RoCEv2IPv4MetricsRequestColumnNamesEnum
	DISCONNECT_REPLY_TX   RoCEv2IPv4MetricsRequestColumnNamesEnum
	DISCONNECT_REPLY_RX   RoCEv2IPv4MetricsRequestColumnNamesEnum
	REJECT_TX             RoCEv2IPv4MetricsRequestColumnNamesEnum
	REJECT_RX             RoCEv2IPv4MetricsRequestColumnNamesEnum
	UNKNOWN_MSG_RX        RoCEv2IPv4MetricsRequestColumnNamesEnum
}{
	SESSION_STATE:         RoCEv2IPv4MetricsRequestColumnNamesEnum("session_state"),
	QP_CONFUGRED:          RoCEv2IPv4MetricsRequestColumnNamesEnum("qp_confugred"),
	QP_UP:                 RoCEv2IPv4MetricsRequestColumnNamesEnum("qp_up"),
	QP_DOWN:               RoCEv2IPv4MetricsRequestColumnNamesEnum("qp_down"),
	CONNECT_REQUEST_TX:    RoCEv2IPv4MetricsRequestColumnNamesEnum("connect_request_tx"),
	CONNECT_REQUEST_RX:    RoCEv2IPv4MetricsRequestColumnNamesEnum("connect_request_rx"),
	CONNECT_REPLY_TX:      RoCEv2IPv4MetricsRequestColumnNamesEnum("connect_reply_tx"),
	CONNECT_REPLY_RX:      RoCEv2IPv4MetricsRequestColumnNamesEnum("connect_reply_rx"),
	READY_TX:              RoCEv2IPv4MetricsRequestColumnNamesEnum("ready_tx"),
	READY_RX:              RoCEv2IPv4MetricsRequestColumnNamesEnum("ready_rx"),
	DISCONNECT_REQUEST_TX: RoCEv2IPv4MetricsRequestColumnNamesEnum("disconnect_request_tx"),
	DISCONNECT_REQUEST_RX: RoCEv2IPv4MetricsRequestColumnNamesEnum("disconnect_request_rx"),
	DISCONNECT_REPLY_TX:   RoCEv2IPv4MetricsRequestColumnNamesEnum("disconnect_reply_tx"),
	DISCONNECT_REPLY_RX:   RoCEv2IPv4MetricsRequestColumnNamesEnum("disconnect_reply_rx"),
	REJECT_TX:             RoCEv2IPv4MetricsRequestColumnNamesEnum("reject_tx"),
	REJECT_RX:             RoCEv2IPv4MetricsRequestColumnNamesEnum("reject_rx"),
	UNKNOWN_MSG_RX:        RoCEv2IPv4MetricsRequestColumnNamesEnum("unknown_msg_rx"),
}

func (obj *roCEv2IPv4MetricsRequest) ColumnNames() []RoCEv2IPv4MetricsRequestColumnNamesEnum {
	items := []RoCEv2IPv4MetricsRequestColumnNamesEnum{}
	for _, item := range obj.obj.ColumnNames {
		items = append(items, RoCEv2IPv4MetricsRequestColumnNamesEnum(item.String()))
	}
	return items
}
...
// SetColumnNames sets the []string value in the RoCEv2IPv4MetricsRequest object
func (obj *roCEv2IPv4MetricsRequest) SetColumnNames(value []RoCEv2IPv4MetricsRequestColumnNamesEnum) RoCEv2IPv4MetricsRequest {

	items := []otg.RoCEv2IPv4MetricsRequest_ColumnNames_Enum{}
	for _, item := range value {
		intValue := otg.RoCEv2IPv4MetricsRequest_ColumnNames_Enum_value[string(item)]
		items = append(items, otg.RoCEv2IPv4MetricsRequest_ColumnNames_Enum(intValue))
	}
