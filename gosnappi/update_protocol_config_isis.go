...
// List of IS-IS interface update groups. One update group targets one or more IS-IS interfaces.
...
//
// An error should be returned if any provided name is not found in the current configuration's list of IS-IS interface names.
