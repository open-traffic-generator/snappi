...
type marshalPatternFlowTcpEcnCwr interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowTcpEcnCwr to raw JSON text
...
func (m *marshalpatternFlowTcpEcnCwr) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowTcpEcnCwr) setDefault() {
	...
	var choice PatternFlowTcpEcnCwrChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowTcpEcnCwrChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowTcpEcnCwrChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowTcpEcnCwrChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowTcpEcnCwrChoice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowTcpEcnCwr")
			}
		} else {
			intVal := otg.PatternFlowTcpEcnCwr_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowTcpEcnCwr_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
