...
type bgpV4RouteRange struct {
	...
	mplsLabelsHolder          BgpV4RouteRangeBgpMplsLabelBindingsIter
}
...
type BgpV4RouteRange interface {
	...
	// MplsLabels returns BgpV4RouteRangeBgpMplsLabelBindingsIterIter, set in BgpV4RouteRange
	MplsLabels() BgpV4RouteRangeBgpMplsLabelBindingsIter
	setNil()
}
...
func (obj *bgpV4RouteRange) MplsLabels() BgpV4RouteRangeBgpMplsLabelBindingsIter {
	if len(obj.obj.MplsLabels) == 0 {
		obj.obj.MplsLabels = []*otg.BgpMplsLabelBindings{}
	}
	if obj.mplsLabelsHolder == nil {
		obj.mplsLabelsHolder = newBgpV4RouteRangeBgpMplsLabelBindingsIter(&obj.obj.MplsLabels).setMsg(obj)
	}
