...
// IsisSRAlgorithm is container for SR-Algorithms. The Isis may use various algorithms when calculating reachability to other nodes or to prefixes attached to these
