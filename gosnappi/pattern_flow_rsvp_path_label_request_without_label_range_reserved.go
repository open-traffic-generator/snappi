...
type marshalPatternFlowRSVPPathLabelRequestWithoutLabelRangeReserved interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowRSVPPathLabelRequestWithoutLabelRangeReserved to raw JSON text
...
func (m *marshalpatternFlowRSVPPathLabelRequestWithoutLabelRangeReserved) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
