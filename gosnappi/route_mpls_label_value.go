...
type RouteMplsLabelValue interface {
	...
	HasStart() bool
	// End returns uint32, set in RouteMplsLabelValue.
	End() uint32
	// SetEnd assigns uint32 provided by user to RouteMplsLabelValue
	SetEnd(value uint32) RouteMplsLabelValue
	// HasEnd checks if End has been set in RouteMplsLabelValue
	HasEnd() bool
...
// The total number of Label Values in the range.
// End returns a uint32
func (obj *routeMplsLabelValue) End() uint32 {
...
// The total number of Label Values in the range.
// End returns a uint32
func (obj *routeMplsLabelValue) HasEnd() bool {
	return obj.obj.End != nil
}

// The total number of Label Values in the range.
// SetEnd sets the uint32 value in the RouteMplsLabelValue object
func (obj *routeMplsLabelValue) SetEnd(value uint32) RouteMplsLabelValue {

	obj.obj.End = &value
	return obj
}

// Increments the Label Value within a route range where multiple routes are present.
...
func (obj *routeMplsLabelValue) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.Start != nil {
		...
		if *obj.obj.Start < 1 || *obj.obj.Start > 1048575 {
			vObj.validationErrors = append(
				...
				fmt.Sprintf("1 <= RouteMplsLabelValue.Start <= 1048575 but Got %d", *obj.obj.Start))
		}
	...
	if obj.obj.End != nil {
		...
		if *obj.obj.End < 1 || *obj.obj.End > 1048575 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("1 <= RouteMplsLabelValue.End <= 1048575 but Got %d", *obj.obj.End))
		}
	...
	if obj.obj.Step != nil {
		...
		if *obj.obj.Step < 1 || *obj.obj.Step > 1048575 {
			vObj.validationErrors = append(
				vObj.validationErrors,
				fmt.Sprintf("1 <= RouteMplsLabelValue.Step <= 1048575 but Got %d", *obj.obj.Step))
		}
