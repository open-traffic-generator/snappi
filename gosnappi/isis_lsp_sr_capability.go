...
type IsisLspSRCapability interface {
	...
	setDefault()
	// IFlag returns bool, set in IsisLspSRCapability.
	IFlag() bool
	// SetIFlag assigns bool provided by user to IsisLspSRCapability
	SetIFlag(value bool) IsisLspSRCapability
	// HasIFlag checks if IFlag has been set in IsisLspSRCapability
	HasIFlag() bool
	// VFlag returns bool, set in IsisLspSRCapability.
	VFlag() bool
	// SetVFlag assigns bool provided by user to IsisLspSRCapability
	SetVFlag(value bool) IsisLspSRCapability
	// HasVFlag checks if VFlag has been set in IsisLspSRCapability
	HasVFlag() bool
...
func (obj *isisLspSRCapability) IFlag() bool {
...
// MPLS IPv4 Flag. If set, then the router is capable of processing SR-MPLS-encapsulated IPv4 packets on all interfaces.
// IFlag returns a bool
func (obj *isisLspSRCapability) HasIFlag() bool {
	return obj.obj.IFlag != nil
}

// MPLS IPv4 Flag. If set, then the router is capable of processing SR-MPLS-encapsulated IPv4 packets on all interfaces.
// SetIFlag sets the bool value in the IsisLspSRCapability object
func (obj *isisLspSRCapability) SetIFlag(value bool) IsisLspSRCapability {
...
func (obj *isisLspSRCapability) VFlag() bool {
...
// MPLS IPv6 Flag. If set, then the router is capable of processing SR-MPLS-encapsulated IPv6 packets on all interfaces.
// VFlag returns a bool
func (obj *isisLspSRCapability) HasVFlag() bool {
	return obj.obj.VFlag != nil
}

// MPLS IPv6 Flag. If set, then the router is capable of processing SR-MPLS-encapsulated IPv6 packets on all interfaces.
// SetVFlag sets the bool value in the IsisLspSRCapability object
func (obj *isisLspSRCapability) SetVFlag(value bool) IsisLspSRCapability {
