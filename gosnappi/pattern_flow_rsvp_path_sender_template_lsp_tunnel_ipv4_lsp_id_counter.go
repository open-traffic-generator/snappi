...
type marshalPatternFlowRSVPPathSenderTemplateLspTunnelIpv4LspIdCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowRSVPPathSenderTemplateLspTunnelIpv4LspIdCounter to raw JSON text
...
func (m *marshalpatternFlowRSVPPathSenderTemplateLspTunnelIpv4LspIdCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
