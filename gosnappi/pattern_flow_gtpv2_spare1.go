...
type marshalPatternFlowGtpv2Spare1 interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpv2Spare1 to raw JSON text
...
func (m *marshalpatternFlowGtpv2Spare1) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowGtpv2Spare1) setDefault() {
	...
	var choice PatternFlowGtpv2Spare1ChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowGtpv2Spare1Choice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowGtpv2Spare1Choice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowGtpv2Spare1Choice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowGtpv2Spare1Choice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowGtpv2Spare1")
			}
		} else {
			intVal := otg.PatternFlowGtpv2Spare1_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowGtpv2Spare1_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
