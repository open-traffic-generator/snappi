...
type protocolsUpdate struct {
	...
	bgpHolder    UpdateProtocolConfigBgp
}
...
type ProtocolsUpdate interface {
	...
	HasIsis() bool
	// Bgp returns UpdateProtocolConfigBgp, set in ProtocolsUpdate.
	...
	Bgp() UpdateProtocolConfigBgp
	// SetBgp assigns UpdateProtocolConfigBgp provided by user to ProtocolsUpdate.
	// UpdateProtocolConfigBgp is a container for BGP properties to be updated. Presence of this object indicates that one or more BGP properties require updating. The choice field selects the category of attributes to be updated. Router-level and interface-level updates are controlled independently.
	SetBgp(value UpdateProtocolConfigBgp) ProtocolsUpdate
	// HasBgp checks if Bgp has been set in ProtocolsUpdate
	HasBgp() bool
	setNil()
}
...
// description is TBD
// Bgp returns a UpdateProtocolConfigBgp
func (obj *protocolsUpdate) Bgp() UpdateProtocolConfigBgp {
	if obj.obj.Bgp == nil {
		obj.obj.Bgp = NewUpdateProtocolConfigBgp().msg()
	}
	if obj.bgpHolder == nil {
		obj.bgpHolder = &updateProtocolConfigBgp{obj: obj.obj.Bgp}
	}
...
// description is TBD
// Bgp returns a UpdateProtocolConfigBgp
func (obj *protocolsUpdate) HasBgp() bool {
	return obj.obj.Bgp != nil
}

// description is TBD
// SetBgp sets the UpdateProtocolConfigBgp value in the ProtocolsUpdate object
func (obj *protocolsUpdate) SetBgp(value UpdateProtocolConfigBgp) ProtocolsUpdate {
