...
type patternFlowUdpDstPort struct {
	...
	randomHolder     PatternFlowUdpDstPortRandom
}
...
type marshalPatternFlowUdpDstPort interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowUdpDstPort to raw JSON text
...
func (m *marshalpatternFlowUdpDstPort) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
type PatternFlowUdpDstPort interface {
	...
	// Random returns PatternFlowUdpDstPortRandom, set in PatternFlowUdpDstPort.
	// PatternFlowUdpDstPortRandom is integer random pattern
	Random() PatternFlowUdpDstPortRandom
	// SetRandom assigns PatternFlowUdpDstPortRandom provided by user to PatternFlowUdpDstPort.
	// PatternFlowUdpDstPortRandom is integer random pattern
	SetRandom(value PatternFlowUdpDstPortRandom) PatternFlowUdpDstPort
	// HasRandom checks if Random has been set in PatternFlowUdpDstPort
	HasRandom() bool
	setNil()
}
...
var PatternFlowUdpDstPortChoice = struct {
	...
	RANDOM    PatternFlowUdpDstPortChoiceEnum
}{
	...
	RANDOM:    PatternFlowUdpDstPortChoiceEnum("random"),
}
...
func (obj *patternFlowUdpDstPort) setChoice(value PatternFlowUdpDstPortChoiceEnum) PatternFlowUdpDstPort {
	...
	if value == PatternFlowUdpDstPortChoice.RANDOM {
		obj.obj.Random = NewPatternFlowUdpDstPortRandom().msg()
	}
...
// description is TBD
// Random returns a PatternFlowUdpDstPortRandom
func (obj *patternFlowUdpDstPort) Random() PatternFlowUdpDstPortRandom {
	if obj.obj.Random == nil {
		obj.setChoice(PatternFlowUdpDstPortChoice.RANDOM)
	}
	if obj.randomHolder == nil {
		obj.randomHolder = &patternFlowUdpDstPortRandom{obj: obj.obj.Random}
	}
...
// description is TBD
// Random returns a PatternFlowUdpDstPortRandom
func (obj *patternFlowUdpDstPort) HasRandom() bool {
	return obj.obj.Random != nil
}

// description is TBD
// SetRandom sets the PatternFlowUdpDstPortRandom value in the PatternFlowUdpDstPort object
func (obj *patternFlowUdpDstPort) SetRandom(value PatternFlowUdpDstPortRandom) PatternFlowUdpDstPort {
	obj.setChoice(PatternFlowUdpDstPortChoice.RANDOM)
	obj.randomHolder = nil
...
func (obj *patternFlowUdpDstPort) setDefault() {
	...
	var choice PatternFlowUdpDstPortChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowUdpDstPortChoice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowUdpDstPortChoice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowUdpDstPortChoice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowUdpDstPortChoice.DECREMENT
	}

	if obj.obj.Random != nil {
		choices_set += 1
		choice = PatternFlowUdpDstPortChoice.RANDOM
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowUdpDstPort")
			}
		} else {
			intVal := otg.PatternFlowUdpDstPort_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowUdpDstPort_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
