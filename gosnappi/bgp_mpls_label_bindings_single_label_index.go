...
type bgpMplsLabelBindingsSingleLabelIndex struct {
	...
	indexHolder  RouteMplsLabelIndex
}
...
type BgpMplsLabelBindingsSingleLabelIndex interface {
	...
	setDefault()
	// Index returns RouteMplsLabelIndex, set in BgpMplsLabelBindingsSingleLabelIndex.
	// RouteMplsLabelIndex is a container of MPLS Prefix Label Index in the address range.
	Index() RouteMplsLabelIndex
	// SetIndex assigns RouteMplsLabelIndex provided by user to BgpMplsLabelBindingsSingleLabelIndex.
	// RouteMplsLabelIndex is a container of MPLS Prefix Label Index in the address range.
	SetIndex(value RouteMplsLabelIndex) BgpMplsLabelBindingsSingleLabelIndex
	// HasIndex checks if Index has been set in BgpMplsLabelBindingsSingleLabelIndex
	HasIndex() bool
	setNil()
}

// description is TBD
// Index returns a RouteMplsLabelIndex
func (obj *bgpMplsLabelBindingsSingleLabelIndex) Index() RouteMplsLabelIndex {
	if obj.obj.Index == nil {
		obj.obj.Index = NewRouteMplsLabelIndex().msg()
	}
	if obj.indexHolder == nil {
		obj.indexHolder = &routeMplsLabelIndex{obj: obj.obj.Index}
	}
	return obj.indexHolder
}

// description is TBD
// Index returns a RouteMplsLabelIndex
func (obj *bgpMplsLabelBindingsSingleLabelIndex) HasIndex() bool {
	return obj.obj.Index != nil
}

// description is TBD
// SetIndex sets the RouteMplsLabelIndex value in the BgpMplsLabelBindingsSingleLabelIndex object
func (obj *bgpMplsLabelBindingsSingleLabelIndex) SetIndex(value RouteMplsLabelIndex) BgpMplsLabelBindingsSingleLabelIndex {

	obj.indexHolder = nil
	obj.obj.Index = value.msg()
...
func (obj *bgpMplsLabelBindingsSingleLabelIndex) validateObj(vObj *validation, set_default bool) {
	...
	if obj.obj.Index != nil {
		...
		obj.Index().validateObj(vObj, set_default)
	}
