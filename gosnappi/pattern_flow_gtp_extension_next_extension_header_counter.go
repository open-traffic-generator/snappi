...
type marshalPatternFlowGtpExtensionNextExtensionHeaderCounter interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowGtpExtensionNextExtensionHeaderCounter to raw JSON text
...
func (m *marshalpatternFlowGtpExtensionNextExtensionHeaderCounter) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
