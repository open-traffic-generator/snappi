...
type marshalPatternFlowVxlanReserved1 interface {
	...
	ToJson() (string, error)
	// ToJsonRaw marshals PatternFlowVxlanReserved1 to raw JSON text
...
func (m *marshalpatternFlowVxlanReserved1) ToJsonRaw() (string, error) {
	vErr := m.obj.validateToAndFrom()
	if vErr != nil {
		return "", vErr
	}
...
func (obj *patternFlowVxlanReserved1) setDefault() {
	...
	var choice PatternFlowVxlanReserved1ChoiceEnum

	if obj.obj.Value != nil {
		choices_set += 1
		choice = PatternFlowVxlanReserved1Choice.VALUE
	}

	if len(obj.obj.Values) > 0 {
		choices_set += 1
		choice = PatternFlowVxlanReserved1Choice.VALUES
	}

	if obj.obj.Increment != nil {
		choices_set += 1
		choice = PatternFlowVxlanReserved1Choice.INCREMENT
	}

	if obj.obj.Decrement != nil {
		choices_set += 1
		choice = PatternFlowVxlanReserved1Choice.DECREMENT
	}
	if choices_set == 0 {
		...
		if obj.obj.Choice != nil {
			if obj.Choice() != choice {
				obj.validationErrors = append(obj.validationErrors, "choice not matching with property in PatternFlowVxlanReserved1")
			}
		} else {
			intVal := otg.PatternFlowVxlanReserved1_Choice_Enum_value[string(choice)]
			enumValue := otg.PatternFlowVxlanReserved1_Choice_Enum(intVal)
			obj.obj.Choice = &enumValue
		}
	}
