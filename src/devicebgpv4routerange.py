...
class DeviceBgpv4RouteRange(SnappiObject):
    ...
    @property
    def name(self):
        """device_bgpv4routerange.name getter
    ...
    @name.setter
    def name(self, value):
        """device_bgpv4routerange.name setter
    ...
    def route_count_per_device(self):
        """device_bgpv4routerange.route_count_per_device getter
    ...
    def route_count_per_device(self, value):
        """device_bgpv4routerange.route_count_per_device setter
    ...
    @property
    def address(self):
        """device_bgpv4routerange.address getter
    ...
    @property
    def prefix(self):
        """device_bgpv4routerange.prefix getter
    ...
    @property
    def as_path(self):
        """device_bgpv4routerange.as_path getter
    ...
    def next_hop_address(self):
        """device_bgpv4routerange.next_hop_address getter
    ...
    @property
    def community(self):
        """device_bgpv4routerange.community getter
